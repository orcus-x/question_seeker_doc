...
config :question_seeker_doc, QuestionSeekerDoc.Repo,
  username: "phoenix",  # PostgreSQL username
  password: "password",  # PostgreSQL password
  database: "question_seeker_doc",  # Name of your PostgreSQL database
  hostname: "localhost",  # Database hostname (localhost for local dev)
